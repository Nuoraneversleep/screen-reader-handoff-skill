...
For **Switch, Checkbox, Radio button, Toggle button, and selectable cells**, leave State blank. TalkBack announces the binary condition automatically — adding it causes "On, on" / "Checked, checked."
